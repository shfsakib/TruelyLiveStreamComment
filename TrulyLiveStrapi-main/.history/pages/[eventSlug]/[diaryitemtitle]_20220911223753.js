...
export default function Video({ navData, footerData, profileData, token, videoData }) {
  ...
  function fixAspect() {
    ...
    videoRef.current.style.height = correctHeight + "px !important";
    videoRef.current.style.minHeight = correctHeight + "px !important";
    videoDivRef.current.style.height = correctHeight + "px !important";
    videoDivRef.current.style.minHeight = correctHeight + "px !important";
    streamRowRef.current.style.minHeight = correctHeight + "px !important";
    streamRowRef.current.style.height = correctHeight + "px !important";
    console.log("After set, height is "+videoRef.current.offsetHeight+videoRef.current.offsetHeight + " should be "+correctHeight+ " style height is "+videoRef.current.style.height )
  }
