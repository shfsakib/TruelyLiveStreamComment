...
export default function Video({ navData, footerData, profileData, token, videoData }) {
  ...
  const handlePinMessageSet = () => {
    var videoScrollHeight = (document.getElementById('streamingVideo'))?document.getElementById('streamingVideo').scrollHeight:0
    windowWidth > 768 ?
      (pinMessage !== '' ?
    ...
    <>
      ...
      <div className="row" id="streamRow" ref={streamRowRef}>
        ...
        <video
          ...
          preload="auto"
          ref={videoRef}
          data-setup='{ "sources": [{ "type": "video/youtube", "src": "https://www.youtube.com/watch?v=IkOVe40Sy0U"}] }'
        ></video>
      </div>
