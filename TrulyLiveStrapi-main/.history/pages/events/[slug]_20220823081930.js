                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!token ? (
                      ...
                      <button
                        ...
                        onClick={() => document.location=eventData?.eventSlug+"/purchase?type="+item?.ticketLevel+'&x=21'}
            ...
            {eventData?.eventTicket?.map((item) => {
              return (
                <button
                  key={item?.id}
                  className="bg-[#222222] text-white py-1 px-2 rounded-md outline-none mr-2"
                  onClick={() => document.location=eventData?.eventSlug+"/purchase?type="+item?.ticketLevel+'&x=212'}
                >
