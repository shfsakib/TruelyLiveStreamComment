...
<<<<<<< Updated upstream
                {profileArrTickets?.includes(item?.ticketLevel) | allTickets?.filter((tix) => tix?.eventTicketType==item?.ticketLevel)[0].price==0 ? (
=======
                {token && (profileArrTickets?.includes(item?.ticketLevel) | allTickets?.filter((tix) => tix?.eventTicketType==item?.ticketLevel)[0].price==0) ? (
>>>>>>> Stashed changes
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!token ? (
                      ...
                      <button
                        ...
                        onClick={() => document.location=eventData?.eventSlug+"/purchase?type="+item?.ticketLevel}
